              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className="text-red-700 font-semibold text-xs uppercase"
                  >
                    Delete
                  </button>
            ...
            <div className="text-center w-60">
              ...
              <div className="mx-auto my-4 w-56">
                ...
                <p className="text-sm text-gray-500">
                  ...
                  <strong>
                    <i>
                      This action will delete all your uploads and cannot be
                      undone
                    </i>
                  </strong>
                </p>
              ...
              <div className="flex gap-4">
                <button
                  onClick={handleDeleteUser}
                  className="w-full p-1 font-semibold rounded-md bg-red-500 text-white"
                >
                  Delete
                </button>
                <button
                  onClick={() => setShowDeleteModal(false)}
                  className="w-full font-semibold p-1 rounded-md bg-slate-200 text-black"
                >
                  Close
                </button>
              </div>
